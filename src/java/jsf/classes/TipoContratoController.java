...
import sessions.beans.TipoContratoFacade;
...
public class TipoContratoController implements Serializable {
    ...
    @EJB
    private sessions.beans.TipoContratoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TipoContratoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TipoContratoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TipoContratoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
