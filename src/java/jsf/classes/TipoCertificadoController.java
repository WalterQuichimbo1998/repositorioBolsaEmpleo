...
import controller.TipoCertificado;
import jsf.classes.util.JsfUtil;
import jsf.classes.util.JsfUtil.PersistAction;
import sessions.beans.TipoCertificadoFacade;
...
public class TipoCertificadoController implements Serializable {
    ...
    @EJB
    private sessions.beans.TipoCertificadoFacade ejbFacade;
    ...
    public List<TipoCertificado> getItems() {
        if (items == null) {
    ...
    public List<TipoCertificado> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
